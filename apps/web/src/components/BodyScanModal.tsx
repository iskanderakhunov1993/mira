    ...
    >
      {phase === "intro" && (
        <div className="scan-intro">
          ...
          <p>
            Mira оценивает качество кадра, видимые пропорции и изменения во
      ...
      {phase === "context" && (
        <div className="scan-context">
          ...
          <h3>Что Mira должна учесть сегодня?</h3>
          <p>
      ...
      {phase === "result" && (
        <div className="body-result">
          ...
          <article className="medical-boundary">
            <EyeOff size={20} />
            <p>
              Mira не определяет диагнозы, процент жира или «нормальность»
